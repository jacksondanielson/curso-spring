...
import com.jackson.cursomc.repository.CategoriaRepository;
import com.jackson.cursomc.repository.CidadeRepository;
import com.jackson.cursomc.repository.ClienteRepository;
import com.jackson.cursomc.repository.EnderecoRepository;
import com.jackson.cursomc.repository.EstadoRepository;
...
import com.jackson.cursomc.repository.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jacksonalves31@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "jacksonalves39@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
